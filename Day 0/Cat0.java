public class Cat0 {//made public lowercase and removed s from cats
	private String name;
	...
	public Cat0(String name, String breed) { //made cat uppercase and added String Breed to the parameter
		this.name = name;
		this.breed = breed;
	...
	public boolean equals(Cat0 other) { //changed = too == and changed into if statement and remove ;
